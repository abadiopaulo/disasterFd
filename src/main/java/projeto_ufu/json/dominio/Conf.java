...
public class Conf implements Serializable {
    ...
    public Conf(String server, int windows_size, long margin, int threshold, boolean alfa, String trace,
	...
	public String getRegionName() {
	    if (outros_monitores != null && outros_monitores.length > 0) {
	        return outros_monitores[0].getHostname();
	    }
